...
site a modern remodel."
        ...
        <GradientBorder className="mb-8 flex w-full flex-col items-center justify-center rounded-lg p-4 md:p-10">
          <p className="mb-4 w-full text-center font-heading text-4xl text-af-light">
            Specialization
          </p>
          <Image
            ...
            className="mb-4"
          />
          <p className="text-center text-2xl text-af-light">
        ...
        <div className=" flex flex-col justify-center gap-8 lg:flex-row">
          <GradientBorder className="flex w-full flex-col justify-start rounded-lg p-4 md:p-10">
            ...
            />
            <p className="text-center text-2xl text-af-light lg:text-left">
