  ...
  return (
    <>
      ...
      <p>
        ...
        in a great, new neighborhood. She is looking to serve coffee, loose leaf
        tea, baked goods, and sandwiches. These offerings will include
        ...
        logo, icon pair, and social media headers. To bring it all together, she
        wants it all packaged in a brand style guide.
      </p>
      <p>
        ...
        communicating with Karla directly. She was happy to completely hand over
        the reins for the design portion of her company’s brand. I checked in
        frequently for Karla’s input.{' '}
        <span className="font-bold">
          This style guide will inform the branding of Midnight Brew’s website,
          printed menus, flyers, business cards, and promotional coffee cups and
          t-shirts
        </span>
        .
      </p>
      ...
      <p>
        I began my research for this project by spending time in some of my own
        favorite coffee shops. I found that a cup of coffee is not the biggest
        product being sold. Buying coffee from a coffee shop is simply a toll we
        pay to be in the presence of others, or simply not be at home. I asked
        my own community of young professionals and found they yearn for a third
        space in their lives. A place that is not home and not the office to
        socialize, create, and work.{' '}
        <span className="font-bold">
      ...
      <p>
        To create a color scheme that fit the brand of Midnight Brew, I tried to
      ...
      <p>
        ...
        handwriting or drawing sketches. I settled on Fredrick the Great because
        it was readable and has the essence of something hand drawn. I chose a
        serif font for other large texts because of its readability and
        allusions to a text book or newspaper.
      </p>
      ...
      <p>
        ...
        <span className="font-bold">
          young student who might study with his friends at Midnight Brew on the
          regular
        </span>
        .
      </p>
      ...
      <div>
        <div>
          ...
          <p>
            ...
            prompts in Adobe Illustrator. I experimented with more flat designs
            that did not bring the vitality that Midnight Brew will bring to its
            community. I ended with an intricate moon design that gives both
            whimsy and sophistication to the logo. This AI-assisted design is a
            vector image and therefore can be used at any size. The logo can be
            used on light backgrounds like coffee cups as well as dark
            backgrounds for menus and flyers.
          </p>
        </div>
      ...
      <h3>Social Media</h3>
      <p>
        In this day and age, every company advertises on social media. I created
        a few templates for banners that could also be easily converted to
        flyers or other ads for Midnight Brew.
      </p>
      {/* facebook images */}
      ...
      <div className="flex">
        <div>
          ...
          <p>
            ...
            products. I used Adobe Illustrator, InDesign, Photoshop and Figma to
            bring this brand to life. Karla is ready to get her brand out there
            to create a space her community has been looking for.
          </p>
        </div>
        <div>
          <StaticImage
