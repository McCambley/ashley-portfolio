  ...
  return (
    <div className="project-page p-0">
      ...
      <p>
        ...
        . My job was to analyze web analytics to create a user persona, journey
        map, and a user-tested Figma prototype. I worked directly with the
        client as well as their data researcher.  The goal for this website was
        to direct customers to rent bikes online rather than calling or showing
        up in-person.
      </p>
      ...
      <p>
        ...
        felt that because not enough people are reserving online, this resulted
        in an influx of phone calls and in-person visits, making it difficult to
        give their customers the care they deserve.
      </p>
      <p>
        ...
        describe the online rental process was “Annoying” and “Frustrating.” It
        was my role to find out what aspect of the process was unclear to
      ...
      <h3>User Persona</h3>
      <p>
        Using these analytics and transcripts of user interviews, I was able to
        create the persona of{' '}
        <span className="font-bold">
      ...
      <h3>Journey Map</h3>
      <p>
        I could then create a journey map of the pain points users experience as
        they are trying to rent a bike online. 
        <span className="font-bold">
          Users become more and more demoralized with each unhelpful click they
          make, resulting in calling City Cycles frustrated and annoyed
        </span>
        .
      </p>
      ...
      <div className="flex">
        <div>
          ...
          <p>
            ...
            possible. I presented my data to the City Cycles stakeholders and it
            was approved immediately! The prototype includes:
          </p>
          <ul>
      ...
      portal. They wanted to know exactly where in the process they were and how
      to move around within the portal. This is why I aimed to make the rental
      process was as easy and intuitive as possible. 
      <h3>Solutions</h3>
      <h4>Home Page:</h4>
      <p>
        I revamped the hero image and text scrolling to be more readable. I also
        added a “Reserve Now” button to make clear how to begin the rental
        process. I also changed one navigation tab from “Hours” to “About Us” to
        help users navigate the site better. I also moved the search bar to the
        top so it is easier to see as well as grouped with the other
        navigational tabs.
      </p>
      ...
      <p>
        I created cards to overlay a darkened hero image for better readability
        and hierarchy. On the first page that appears after clicking the
        “Reserve Now” button, this card appears with a date and time picker so
        the user knows what bikes are available on the day they choose.
      </p>
      <StaticImage
      ...
      <p>
        ...
        the card to select the bike. This, along with a quantity counter, allows
        users to rent different bikes for a group of people in one reservation
        process.
      </p>
      ...
      <p>
        ...
        ability to edit your bike selection and/or time and date. The user also
        has the ability to go back to the previous card using the “Back Button.”
        This way, the user feels like they know exactly where they are and how
        to move within the rental process.
      </p>
      ...
      <p>
        ...
        information was a bit messy and could have a lot of potential. However,
        there was only so much money and time City Cycles wanted to spend on
