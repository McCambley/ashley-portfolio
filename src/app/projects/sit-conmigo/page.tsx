  ...
  return (
    <>
      ...
      <p>
        ...
        sustainably-made household chairs. Their founder Yolanda Lopez hired me
        to create a mock-up of a mobile, tablet, and website designs. As well as
        a prototype of the mobile checkout process. She wanted the{' '}
        <span>
        ...
        . All with the purpose of urging people to pre-order her stylish chairs.
      </p>
      <p>
      ...
      <p>
        ...
        became evident that there needed to be a more neutral color in the mix.
        I was immediately drawn to the golden yellow as an accent color to show
        the relatability of the Sit Conmigo staff and mission.
      </p>
      <p>
      ...
      <p>
        ...
        wireframe. Yolanda had me go ahead and create a mock-up of the checkout
        process for mobile. Once I got a prototype up and running for the mobile
        site, it was ready to user test!
      </p>
      ...
      <div className="flex">
        <div>
          <h3>Prototyping</h3>
          <p>
            With the designs approved, I created a mobile check-out process that
            was elegant and efficient. It consists of:
          </p>
          <ul>
            <li>
            ...
            <li>
              Multiple options for users to go back to previous pages throughout
      ...
      <p>
        ...
        also asked to describe how the site demonstrated the company’s mission.
        After 2 rounds of user testing, it was evident that users enjoyed the
        layout of chair photos and prices, but felt a bit confused and confined
        in the checkout process. They also stated that the site did not put
        enough emphasis on the mission of Sit Conmigo.{' '}
      </p>
      <StaticImage image={userQuotes} alt="User quotes" />
      <blockquote>
        Users wanted more company information before they could feel confident
        in their purchase. Also, more ability to move backwards in the checkout
        process.
      </blockquote>
      <h3>Solutions</h3>
      <h4>Homepage</h4>
      <p>
        First, I addressed the lack of enthusiasm to begin the pre-order process
        and the desire for more information on the company. I did this through
        emphasizing the company’s sustainability practices by displaying their
        many eco-friendly certifications. This along with a mission statement
        gives a more comprehensive vision of the company’s ethos. 
      </p>
      <div className="flex">
      ...
      <p>
        ...
        process, there is a small description of where the chair would fit best
        in the user’s home. This simple comparison method allows the user to
        feel even more sure they want to continue to Pre-Order. 
      </p>
      <StaticImage image={ourChairsIphone} alt="Our chairs phone" />
      <h4>Product Page</h4>
      <p>
        While working on this page, it became clear that lightening the
        background hue to a light beige allows the brand color to pop. I added a
        “Back to Shop” button so users felt they could look back at other chairs
        if they felt unsure about the one they had selected.
      </p>
      ...
      <p>
        ...
        chair, the payment information was expanded to three cards and numbered
        each step so users knew where they were in the checkout process. A
        “Cancel Order” button was added to allow more freedom to shop if
        needed. 
      </p>
      <StaticImage image={yourCartPhone} alt="Your cart phone" />
      <h4>Confirmation Page</h4>
      <p>
        Users felt like the confirmation page needed to be more clear. So I made
        more apparent buttons for viewing their order confirmation and back to
        shopping for chairs. While also making the “Contact Us” section still
        visible on the mobile phone in case customers have questions about their
        purchase.
      </p>
      <StaticImage image={confirmationPhone} alt="Confirmation phone" />
      <h3>Challenges</h3>
      <p>
        I found that the more feedback the better. I received multiple rounds of
        feedback beyond just user testing. There were times when many iterations
        were needed, and other times when finding a solution and moving on was
        necessary.
      </p>
      <p>
        Doing a mobile-first design for Yolanda helped me keep the MVP in mind.
        I learned the importance of combining style with minimalism. Keeping
